...
export default function Hero() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-40 top-1/4 h-[420px] w-[420px] rounded-full bg-accent/20 blur-[120px]"
      />
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-14 px-6 md:grid-cols-2 md:items-center">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.p
            variants={item}
            className="mt-3 text-xl font-medium text-accent-pale sm:text-2xl"
          >
          ...
          >
            ...
            <Button asChild variant="outline" size="lg">
              <a
                href="/Halim_Shabalout_CV.pdf"
                download
                aria-label="Download Halim Shabalout CV"
              >
          ...
          <motion.div variants={item} className="mt-9 flex items-center gap-5">
            ...
            <a
              ...
              aria-label="Send email to Halim Shabalout"
              className="text-muted-foreground transition-colors hover:text-foreground"
            >
        ...
        >
          <div className="mx-auto max-w-md overflow-hidden rounded-2xl border border-accent/30 bg-navy-900 shadow-2xl shadow-black/40">
            <div className="flex items-center gap-2 border-b border-navy-600 bg-navy-800 px-4 py-3">
              ...
              <span className="ml-3 font-mono text-xs text-[#6e93b8]">
                profile.ts
              </span>
            </div>
            ...
            <pre className="overflow-x-auto p-5 font-mono text-[13px] leading-7 text-[#cfe0ee]">
              <code>
                ...
                ,{"\n"}
                {"  "}experience:{" "}
                <span className="text-[#6fcf97]">&quot;4+ years&quot;</span>,
                {"\n"}
                {"  "}stack: [
                <span className="text-[#6fcf97]">&quot;React&quot;</span>,{" "}
                <span className="text-[#6fcf97]">&quot;Next.js&quot;</span>,{" "}
                <span className="text-[#6fcf97]">&quot;NestJS&quot;</span>],
                {"\n"}
                {"  "}location:{" "}
                <span className="text-[#6fcf97]">&quot;Jeddah, KSA&quot;</span>,
                {"\n"}
                {"  "}status:{" "}
                <span className="text-[#6fcf97]">&quot;Open to work&quot;</span>
                ,{"\n"}
                {"};"}
              </code>
            </pre>
